           ...
           <div class="row">
               <div class="col-md-3">
                   <nav class="navbar bg-light">
                       <ul class="navbar-nav">
                           ...
                           <li class="nav-item">
                               <a class="nav-link" href="#"><i class="fa fa-plus-square"></i>Women</a>
                           </li>
                       </ul>
                   </nav>
               </div>
               ...
               <div class="col-md-3">
                   <div class="header-img">
                       ...
                       <div class="img-item">
                           <img src="assets/img/product_img_1.jpg" />
                           <a class="img-text" href="">
                               <p>Some text goes here that describes the image</p>
                           </a>
                       </div>
   ...
   <div class="call-to-action">
       <div class="container-fluid">
           <div class="row align-items-center">
               ...
               <div class="col-md-6">
                   <a href="tel:0123456789">890-246-6321</a>
               </div>
           </div>
       </div>
   </div>
   ...
   <div class="featured-product product">
       <div class="container-fluid">
           <div class="section-header">
               <h1 id="best seller">Best Selling Product</h1>
           </div>
               ...
               <div class="col-lg-3">
                   <div class="product-item">
                       <div class="product-title">
                           <a href="product_detail.php">PRODUCT 1</a>
