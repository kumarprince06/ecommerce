                    ...
                    <div class="container">
                        <div class="pagination">
                            ...
                            for ($i = 1; $i <= $numberOfPages; $i++) {
                                echo "<a class='" . ($i == $page ? 'active' : '') . "' href='products.php?page=" . $i . "'>" . $i . "</a>";
                            }
...
<script>
    function go2Page(page, numberOfPages) {
        ...
        if (enteredPage >= 1 && enteredPage <= numberOfPages) {
            window.location.href = 'products.php?page=' + enteredPage;
        } else {
            window.location.href='products.php?page='+numberOfPages;
        }
    }
    // function go2Page(page, numberOfPages) {
    //     var pageInput = document.getElementById("page");
